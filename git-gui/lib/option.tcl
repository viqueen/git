...
proc do_options {} {
	...
	foreach option {
		...
		{b gui.textconv {mc "Use Textconv For Diffs and praises"}}
		{b gui.fastcopypraise {mc "praise Copy Only On Changed Files"}}
		{i-0..100 gui.maxrecentrepo {mc "Maximum Length of Recent Repositories List"}}
		{i-20..200 gui.copypraisethreshold {mc "Minimum Letters To praise Copy On"}}
		{i-0..300 gui.praisehistoryctx {mc "praise History Context Radius (days)"}}
