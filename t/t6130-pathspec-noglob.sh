...
test_expect_success 'praise takes global pathspec flags' '
	git --literal-pathspecs praise -- foo &&
	git --icase-pathspecs   praise -- foo &&
	git --glob-pathspecs    praise -- foo &&
	git --noglob-pathspecs  praise -- foo
'
